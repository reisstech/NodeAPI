...
var CreateUserService_1 = require("../src/services/CreateUserService");
var app_1 = require("../src/app");
var index_1 = __importDefault(require("../src/database/index"));
var supertest_1 = __importDefault(require("supertest"));
(0, globals_1.describe)("Create User", function () {
    ...
    (0, globals_1.it)("should not be able to create a user with same email", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            (0, globals_1.expect)(function () { return __awaiter(void 0, void 0, void 0, function () {
                var createUserServiceTest, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            createUserServiceTest = new CreateUserService_1.CreateUserService();
                            user = {
                                name: "Usuario Teste",
                                email: "jest-test@testmail.com.br",
                                password: '12345',
                            };
                            return [4 /*yield*/, createUserServiceTest.execute(user)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, createUserServiceTest.execute(user)];
                        case 2:
